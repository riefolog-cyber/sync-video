# Prompt per NotebookLM — WORKFLOW 1: PODCAST → PRESENTAZIONE





Da incollare in "Istruzioni / Personalizza" quando generi il podcast:
...
CONSECUTIVO: slide 1, 2, 3, … fino all'ultima, senza mai saltarne una.
All'inizio di OGNI sezione (dalla seconda in poi) pronuncia esplicitamente
il numero come transizione, es. "passiamo alla slide 10". Usa SEMPRE i
numeri IN CIFRE: "slide 10", mai "slide dieci". Pronuncia la parola
"slide" (o "diapositiva") in modo CHIARO e separato dal numero: un
sistema di trascrizione automatica la riconosce meglio di "slide" se
parlata di fretta. Pronuncia SEMPRE il numero completo: NON dire mai
solo "la slide successiva" o "la numero tre" — ripeti il numero (es.
"passiamo alla slide 2", "e ora la slide 3"). Se ti accorgi di aver saltato
un numero, torna indietro e recuperalo subito.
Per ogni sezione: 1) annuncia "slide N"; 2) cita il titolo della sezione;
3) spiega tutti i punti e le parole chiave della slide, pronunciando le
...
All'inizio della prima sezione l'introduzione deve essere naturale, senza
dire che si seguirà una scaletta. La prima transizione numerata ("slide 2")
arriva solo alla fine della prima sezione.

Il dialogo può rimanere naturale, ma la frase "passiamo alla slide N"
(or "alla diapositiva N") deve apparire all'inizio di OGNI sezione a
partire dalla seconda, senza eccezioni. NON abbandonarla mai a metà
episodio.
