...
rem
rem Prima passa cerca una versione che abbia GIÀ le dipendenze del progetto
rem (fastembed): se un Python esiste ma è "nudo" (es. py -3.13 appena
...
rem bootstrap di main.py installerà tutto da solo.
rem
